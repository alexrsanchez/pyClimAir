...
- In :func:`pyclimair.common.plot_variable_trends`, :func:`pyclimair.common.compute_and_plot_exceedances` and :func:`pyclimair.common.plot_periodaverages`, when grouping_stat is 'sum', if all values are NaN it now plots as NaN instead of zero. This fixes wrong trend and averages computations due to unrealistic zeros.

- :func:`pyclimair.categories_evolution` now shows NaN values, fixing unrealistic frequencies

Enhancements
------------
- :func:`pyclimair.common.categories_evolution` now creates categories' labels automatically, disappearing the "categories_labels" argument.
...
- Simplification of the :func:`pyclimair.common.plot_data_and_accum_anoms` and  :func:`pyclimair.common.plot_data_and_annual_cycle` functions: Now they read a single variable instead of a list of variables.

- In :func:`pyclimair.common.plot_data_vs_climate`, bottom y-axis limit set to 0 for "Rainfall" to improve visualization.

- Improved visuals for :func:`pyclimair.common.timeseries_extremevalues` function